wget https://github.com/linkerd/linkerd2/releases/download/edge-20.10.5/linkerd2-cli-edge-20.10.5-linux-amd64 && mv -f linkerd2-cli-edge-20.10.5-linux-amd64 /usr/local/bin/linkerd && chmod +x /usr/local/bin/linkerd && linkerd version
